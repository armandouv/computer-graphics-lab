...
int main() {
    ...
    // Lineas para leer el archivo adecuadamente en Linux (comentar)
    // /*
    std::string base_path{"/home/armandouv/Documents/Projects/computer-graphics-lab/P2/ejercicio/Shaders/"};
    auto vertex_path{base_path + "core.vs"};
    auto fragment_path{base_path + "core.frag"};
